...
import { Package, IndianRupee, CalendarDays, MapPin, Phone, Truck, CheckCircle, Clock, AlertCircle, ShoppingBag, Eye } from 'lucide-react';
...
// Add handleDownloadInvoice function (copy from order-history/page.tsx)
      ...
      <div className="container mx-auto px-4 py-8 text-center md:px-6 lg:py-12">
        ...
        <Card className="max-w-md mx-auto">
          <CardContent className="pt-6">
            ...
            <p className="text-muted-foreground mb-4">Please sign in to access your orders and track your purchases.</p>
            <Button asChild className="w-full">
              <Link href="/sign-in?redirect_url=/orders">Sign In</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
              ...
              <Card key={order._id} className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
                ...
                <CardFooter className="bg-gray-50 p-6">
                  <div className="flex flex-col sm:flex-row gap-3 w-full">
                    ...
                    <Button onClick={() => handleDownloadInvoice(order)}>Download Invoice</Button>
                  </div>
                </CardFooter>
              </Card>
            );
